...
export const skills: { Icon: { Element: IconType; color?: string }; label: string; rating: number }[] = [
	...
	{ Icon: { Element: FaC, color: 'text-[#5D6BC1]' }, label: 'C', rating: 2 },
	{ Icon: { Element: SiCplusplus, color: 'text-[#659BD3]' }, label: 'C++', rating: 2 },
	{ Icon: { Element: FaDocker, color: 'text-[#0091E2]' }, label: 'Docker', rating: 5 },
	...
	{ Icon: { Element: FaAws, color: 'text-[#FF9900]' }, label: 'AWS', rating: 4 },
	{ Icon: { Element: DiGoogleCloudPlatform, color: 'text-[#2FA1FB]' }, label: 'GCP', rating: 3 },
	...
	{ Icon: { Element: SiConstruct3, color: 'text-[#DAE8F6]' }, label: 'Construct 3', rating: 2 },
